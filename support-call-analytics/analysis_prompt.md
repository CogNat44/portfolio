...
=== EXAMPLE ROW ===
Call recording of (249) 387-0613 at 2025-08-27 09-58-28.txt|Call|2025-08-27|09:58:28|Outbound|Ty (Cognition Support)|Brian (Napa Auto Parts Installer)|Napa Auto Parts - 429 William|North furnace; South furnace|N/A|Furnace|Hardware Install Support|Installation onboarding|Ty saw new device traffic on dashboard|Proactive post-install check-in; dashboard QR login bug|2|HVAC Installation; Dashboard Access|Mix|2|Device telemetry; firmware version; dashboard auth status|Positive - cooperative|Fix dashboard QR code login bug to eliminate installer confusion
